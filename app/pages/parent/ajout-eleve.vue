      ...
      <div class="p-8 h-full flex flex-col">
        ...
        <div class="flex items-center gap-3 mb-12 group cursor-pointer" @click="goToDashboard">
          ...
          <div>
            ...
            <p :class="isDark ? 'text-purple-300' : 'text-purple-600'" class="text-sm font-medium mt-1">Création Élève</p>
          </div>
        </div>
        ...
        <nav class="pt-6" :class="isDark ? 'border-purple-400/20' : 'border-purple-400/30'">
          <div :class="isDark ? 'bg-slate-800/30 border-white/10' : 'bg-white/30 border-gray-300/30'" class="p-4 rounded-2xl border shadow-2xl backdrop-blur-xl transition-colors duration-500">
            ...
            >
              ...
              <span :class="isDark ? 'text-white group-hover:text-blue-200' : 'text-gray-800 group-hover:text-blue-600'" class="font-bold transition-colors duration-300 relative z-10">Créer Élève</span>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
              ...
              <div class="space-y-2">
                <label :class="isDark ? 'text-purple-300' : 'text-purple-600'" class="block text-sm font-bold flex items-center gap-2">
                  <i :class="isDark ? 'text-purple-400' : 'text-purple-500'" class="fas fa-graduation-cap text-xs"></i>
                  Classe *
                </label>
                <select 
                  ...
                  class="w-full px-3 py-2 rounded-xl focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 shadow-lg text-sm backdrop-blur-sm appearance-none"
                >
...
const handleSubmit = async () => {
  ...
  if (!form.value.nom_famille || !form.value.prenom || !form.value.courriel || !form.value.niveau_id) {
  ...
  try {
    ...
    showMessage(' Élève créé avec succès ! Redirection...', 'success')
