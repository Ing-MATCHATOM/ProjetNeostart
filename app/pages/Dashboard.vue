      ...
      <div class="p-4 lg:p-6 h-full flex flex-col">
        ...
        <nav class="flex-1 space-y-2">
          <NuxtLink to="/parent/create-enseignant" class="nav-link-enhanced group">
            ...
            <span class="hidden lg:block">Créer Enseignant</span>
          </NuxtLink>
          <NuxtLink to="/parent/create-eleve" class="nav-link-enhanced group">
            ...
            <span class="hidden lg:block">Créer Élève</span>
          </NuxtLink>
          <NuxtLink to="/parent/create-temoin" class="nav-link-enhanced group">
            ...
            <span class="hidden lg:block">Créer Témoin</span>
          </NuxtLink>
          <a href="/parent/rapport-parent" class="nav-link-enhanced group">
          ...
          <a href="/parent/emploi-parent" class="nav-link-enhanced group">
          ...
          <a href="/parent/mesreports" class="nav-link-enhanced group">
            <i class="fas fa-calendar-alt text-red-500 group-hover:text-white transition-colors"></i>
            <span class="hidden lg:block">Reports</span>
          </a>
          <a href="/parent/stat" class="nav-link-enhanced group">
            <i class="fas fa-calendar-alt text-red-500 group-hover:text-white transition-colors"></i>
